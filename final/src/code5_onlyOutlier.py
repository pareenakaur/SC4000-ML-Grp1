...
Output Files:
1. /data/check_point/correlation_onlyOutlier.feather
2. /data/processed/feature_correlation_only_outlier.csv
"""
...
null_imp_df.to_feather("/home/UG/aarushi003/SC4000_Final/data/check_point/correlation_onlyOutlier.feather")
...
corr_scores_df.to_csv('/home/UG/aarushi003/SC4000_Final/data/processed/feature_correlation_only_outlier.csv', index=False)
